...
export const MATERIALS: Record<string, MaterialDef> = {
  aerogel:   { id: "aerogel", name: "Aerogel", density: 1.0, color: 0xdfe8ee, restitution: 0.1 },
  styrofoam: { id: "styrofoam", name: "Styrofoam", density: 75, color: 0xf2f2f2, restitution: 0.3 },
  oak:       { id: "oak", name: "Oak Wood", density: 750, ignitionC: 300, tensileMpa: 40, youngGpa: 11, poisson: 0.3, mohs: 2.5, soundMs: 3850, muS: 0.4, muK: 0.2, color: 0x7a5230, restitution: 0.4 },
  water:     { id: "water", name: "Water", density: 1000, meltC: 0, thermalWmK: 0.6, soundMs: 1481, color: 0x1a3a55, restitution: 0 },
  concrete:  { id: "concrete", name: "Concrete", density: 2400, tensileMpa: 3.5, yieldMpa: 30, ultimateMpa: 30, youngGpa: 30, poisson: 0.2, thermalWmK: 1.0, color: 0x8a8a86, restitution: 0.1 },
  glass:     { id: "glass", name: "Window Glass", density: 2500, yieldMpa: 70, ultimateMpa: 150, thermalWmK: 1.7, mohs: 5.5, soundMs: 4540, color: 0xbfe0e8, restitution: 0.2 },
  ...
  iron:      { id: "iron", name: "Iron", density: 7874, meltC: 1538, color: 0x6b6f72, restitution: 0.3 },
  ...
  lead:      { id: "lead", name: "Lead", density: 11340, meltC: 327.5, color: 0x4a4d52, restitution: 0.15 },
  gold:      { id: "gold", name: "Gold", density: 19300, meltC: 1064, color: 0xd4af37, restitution: 0.2 },
  copper:    { id: "copper", name: "Copper", density: 8960, meltC: 1085, thermalWmK: 401, color: 0xb87333, restitution: 0.3 },
  bronze:    { id: "bronze", name: "Bronze", density: 8800, meltC: 913, color: 0xa67c3d, restitution: 0.3 },
  ...
  diamond:   { id: "diamond", name: "Diamond", density: 3510, meltC: 4027, thermalWmK: 2200, mohs: 10, soundMs: 12000, color: 0xcfe8ff, restitution: 0.5 },
  rubber:    { id: "rubber", name: "Rubber", density: 1500, youngGpa: 0.05, poisson: 0.5, soundMs: 60, muS: 1.0, muK: 0.8, color: 0x222222, restitution: 0.85 },
  teflon:    { id: "teflon", name: "Teflon", density: 2200, muS: 0.04, muK: 0.04, color: 0xe8e8e8, restitution: 0.2 },
